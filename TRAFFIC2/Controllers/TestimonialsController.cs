...
namespace TRAFFIC2.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        {
            var testimonial = _context.Testimonials.Include(t => t.User).FirstOrDefault(t => t.TestimonialId == id);
            if (testimonial == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("TestimonialId,UserId,TestimonialText,Status")] Testimonial testimonial)
        {
            ...
            ViewData["UserId"] = new SelectList(_context.Logins, "UserId", "UserId", testimonial.UserId);
            return View(testimonial);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("TestimonialId,UserId,TestimonialText,Status")] Testimonial testimonial)
        {
